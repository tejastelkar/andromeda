  ...
  return (
    <div style={{
      ...
      >
        ...
        <h1 style={{ fontSize: '24px', fontWeight: 600, marginBottom: '8px', width: '100%', textAlign: 'left' }}>Create an account</h1>
        <p style={{ color: 'rgba(255,255,255,0.6)', fontSize: '14px', marginBottom: '32px', width: '100%', textAlign: 'left' }}>
          Join Andromeda Studio today.
        </p>

        <form onSubmit={handleEmailSignUp} style={{ width: '100%', display: 'flex', flexDirection: 'column', gap: '16px' }}>
          <input
            type="text"
        ...
        <p style={{ marginTop: '32px', fontSize: '14px', color: 'rgba(255,255,255,0.6)' }}>
          ...
          <Link to="/signin" style={{ color: '#fff', textDecoration: 'none', fontWeight: 500 }}>Sign in</Link>
        </p>
      </motion.div>
    </div>
  );
